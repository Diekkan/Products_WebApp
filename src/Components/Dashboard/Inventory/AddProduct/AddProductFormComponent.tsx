...
const AddProductFormComponent = ({onSubmit, cancelButtonRef, setOpen}:AddProductFormComponentProps) => {
    ...
    return(
        <form className="w-96 flex flex-col" onSubmit={onSubmit}>
            ...
            <label htmlFor="quantity" className="block text-sm font-medium leading-6 text-gray-900 mt-4">
                Cantidad
            </label>
            <div className="mt-2">
                <div className="flex w-40 rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
            ...
            <div className="bg-gray-50 py-3 w-full sm:flex sm:flex-row-reverse justify-start w-96">
                  <button
                    type="submit"
                    className="inline-flex w-full justify-center rounded-md bg-slate-800 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-slate-600 sm:ml-3 sm:w-auto"
